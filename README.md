...
The primary users of this application are students at Fraser International College, who need a quick and accurate way to self-report their attendance. Upon logging in with their credentials, students are presented with a real-time, interactive map of their specific classroom. They can easily check seat availability (green for empty and red for taken), and simply click on their chosen seat to mark themselves as present during an active session.

The second user group are instructors. They use the app to manage classroom sessions and efficiently monitor lecture attendance. Through the platform, professors can easily initiate and conclude attendance sessions for specific class periods. They also have access to a live map of student seating to verify presence, the ability to modify desk layouts for different classroom, and the convenience of automatically tracking and recording attendance data.

Finally are administators. They interact with the application to maintain overall system integrity and manage institutional data. While they are less focused on daily classroom activities, they are responsible for ensuring that the underlying infrastructure supporting students and instructors runs smoothly, securely, and accurately reflects the college's records.
...
Member 1:  Student Attendance Check-In Module
